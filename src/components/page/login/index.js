          ...
          <Form onSubmit={this.toSubmit} className="login-form">
            <FormItem>
              {getFieldDecorator('name', {
                ...
                <Input onPressEnter={this.toSubmit} prefix={<Icon type="user" style={{color: 'rgba(0,0,0,.25)'}}/>}
            ...
            <FormItem className="clear-margin-bottom">
              {getFieldDecorator('password', {
                ...
                <Input onPressEnter={this.toSubmit} prefix={<Icon type="lock" style={{color: 'rgba(0,0,0,.25)'}}/>}
                       type="password"
